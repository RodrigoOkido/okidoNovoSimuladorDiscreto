...
public class SimulacaoAutoEscola implements SimuladorInterface
{
        ...
        for(int tempo=0; tempo<duracao; tempo++)
        {
            ...
            if(caixa.estaVazio())
            {
                ...
                if(!fila.isEmpty())
                {
                    ...
                    if(trace)
                    	statTempoAtendimentoCaixa.adicionar(caixa.getClienteAtual().getTempoAtendimento());
    ...
    public void imprimirResultados()
    {
        ...
        System.out.println("Numero total de clientes atendidos:" + caixa.getNumeroAtendidos());
        ...
        System.out.println("Tempo medio de atendimento no guichê 1:" + statTempoAtendimentoCaixa.getMedia());
        System.out.println("Numero de clientes atendidos no guichê 1: "+caixa.getNumeroAtendidos());
